...
首先，我在数据集第一行加入了一行属性，如下图所示：
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.5\textwidth]{图片/数据集.png}
  \qquad
\end{figure}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{图片/1.png}
  \qquad
\end{figure}
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{图片/2.png}
  \qquad
\end{figure}
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{图片/3.png}
  \qquad
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.85\textwidth]{图片/Figure_1.png}
  \qquad
\end{figure}
